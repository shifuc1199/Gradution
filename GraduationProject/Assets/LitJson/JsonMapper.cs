...
namespace LitJson
{
    ...
    {
        void OnJsonToObjectFinished();
        void OnObjectToJsonStarted();
    }
    ...
    {
        public static Dictionary<string, Type> PropertyEnumKeys = new Dictionary<string, Type>();
        #region Fields
        ...
        private static void RegisterBaseExporters ()
        {
            ...
            base_exporters_table[typeof (char)] =
                delegate (object obj, JsonWriter writer) {
                    writer.Write (Convert.ToString ((char) obj),true);
                };
        ...
        public static void ToJson (object obj, JsonWriter writer, bool hex = true)
        {
            WriteValue (obj, writer, false, 0, hex);
        }
        ...
        {
            T ret = (T)ReadValue(typeof(T), reader);
            if (ret as IJsonReader != null)
            {
                (ret as IJsonReader).OnJsonToObjectFinished();
            }
            return ret;
        }
        ...
        public static T ToObject<T> (TextReader reader)
        {
            ...
            T ret = (T)ReadValue(typeof(T), json_reader);
            if (ret as IJsonReader != null)
            {
                (ret as IJsonReader).OnJsonToObjectFinished();
            }
